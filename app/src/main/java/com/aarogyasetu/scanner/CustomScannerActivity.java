...
import com.aarogyasetu.scanner.db.DatabaseClient;
import com.aarogyasetu.scanner.db.ScannedUser;
...
public class CustomScannerActivity extends Activity implements CustomCaptureManager.CaptureViewListener {
  ...
  /*  private void onGenerateQrClick() {
    ...
    private void showPersonStatus(String scannerName, String mobileNo, int statusCode, String
        ...
        saveToDB(scannerName, mobileNo, currentDate, message);
    ...
    public void saveToDB(String name, String mobile_no, String scanned_by, String status) {
        ...
        class SaveTask extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                ScannedUser scannedUser = new ScannedUser(name, mobile_no, scanned_by, status);
                //adding to database
